...
export const TeacherInfoStore = defineStore('teacherInfo', () => {
    ...
    const teacherList = [
        {
            name: "王雷",
            title: '网络专业负责人',
            img: 'https://test.hebic.cn/uploadfile/2023/0918/20230918043607442.jpg',
            desc: {
        ...
        },
        {
            name: "刘正华",
            title: '教授',
            img: 'https://www.hebic.cn/uploadfile/2015/0528/20150528070853797.jpg',
            desc: {
        ...
        },
        {
            name: "范村勇",
            title: '高级工程师',
            img: 'https://test.hebic.cn/uploadfile/2023/0919/20230919034637788.jpg',
            desc: {
        ...
        },
        {
            name: "崔荣梅",
            title: '硕士研究生',
            img: 'https://test.hebic.cn/uploadfile/2023/0919/20230919034945434.jpg',
            desc: {
        ...
        },
        {
            name: "宋凯",
            title: '硕士研究生',
            img: 'https://test.hebic.cn/uploadfile/2023/0314/20230314020429178.jpg',
            desc: {
        ...
        //     name: "郑艾明",
        //     title: '讲师',
        //     desc: '男，讲师、学士学位。现任河北传媒学院信息技术与文化管理学院辅导员。2004—2005学年度获院级先进工作者称号2011年获院级科研成果科研立项课题优秀奖2011年度“无烟校园，你我共创”校风活动月中获最佳组织奖',
        //     img: 'https://www.hebic.cn/uploadfile/2015/0529/20150529111058344.png',
        //     desc: {
        //         eduExp: "",
        //         area: "",
        //         honor: ['2004—2005学年度获院级先进工作者称号','2011年获院级科研成果科研立项课题优秀奖','2011年度“无烟校园，你我共创”校风活动月中获最佳组织奖','2012—2013学年度获院级先进工作者称号','2012—2013学年获得宿舍文化建设先进工作者'],
        //         Exp: ['积极学习各种教育理论以充实自己，以便在工作中以坚实的理论作为指导，加强自身基本功的训练。对差生给予更多的关心、爱心以及多一些耐心，使他们在各方面都有更大的进步。',
        //             '在职以来所带学生，8名升本并取得了不错的工作，4名读研已毕业，1名现在在英国就职。11年所带学生现在有36名准备接本，考研人数也在不断增加。在工作中我认真学习上级有关文件、新时期教育思想、新课改的理论，努力提高业务能力，及时把握考研学生学习生活的思想动向，特别是在学生的学习中刻意引导他们热爱祖国，学习党的18大精神；并把这些新的教育教学理念努力的贯彻到自己的教育教学实践中。'
        //         ],
        //     }
        // },
        {
            ...
            img: 'https://test.hebic.cn/uploadfile/2023/0919/20230919080143233.jpg',
            desc: {
    ...
    // 教师详情页
   const teacherInfo = ref({name:'王雷',img:"https://www.hebic.cn/uploadfile/2015/0528/20150528070853797.jpg",desc:"2333333"});
    // 更新教师信息
